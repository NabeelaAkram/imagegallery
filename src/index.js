...
function Image(props){
  return(<div style={{display:"flex",border:"solid"}}>
    <div >
      <img  src={props.image} alt="image" style={{width:"250px" ,height:"250px" ,boxShadow:"30px grey"}}></img>
...
root.render(<div>
<Title></Title>
    <div style={{display:"flex", flexWrap:"wrap", gap:"20px",justifyContent:"center",boxShadow:"initial"}}>
    {
